...
import { taskConditions, scoreZeroSetting, gameOverWiners } from "../../common_scripts/messages.js"
...
function isGameOver() {
    if (countSolvedTasks === 9) {
        let active;
        scoreText.textContent = scoreZeroSetting["oneTeam"];
        popUpGameOver.classList.add("popup_is-opened");
        popUpGameOverText.textContent = gameOverWiners["score"] + score;
